...
public class SortedList<E> implements ISortedList {
	...
	/**
	 * Removes an object from the SortedList
	 * @param index the index of the element being removed from the SortedList
	 ...
	 * @return true or false based on whether the SortedList contains object
	 */
